...
class TaskManager:
    ...
    def serialize_task(task: Dict[str, Any] | None, *, summary: bool = False) -> Dict[str, Any] | None:
        ...
        if summary:
            return {
                ...
                "run_environments": copy.deepcopy(list(task.get("run_environments", []) or [])),
                "records": [],
                "tracks": [],
    ...
    def _load_task_dir(
        ...
        *,
        ...
        task = {
            ...
            "launch_command": info.get("launch_command"),
            "launch_workdir": info.get("launch_workdir"),
            "launch_started_at": info.get("launch_started_at"),
            "launch_run_index": info.get("launch_run_index"),
            ...
            "run_environments": info.get("run_environments", []),
    ...
    def _task_snapshot(task: Dict[str, Any]) -> tuple:
        ...
        return (
            ...
            task.get("shell_kind"),
            repr(task.get("launch_command")),
            task.get("launch_workdir"),
