...
ENV_KEY_CLI_SHELL_EXECUTABLE = "PYRUNS_CLI_SHELL_EXECUTABLE"
ACTIVE_WORKSPACE_FILENAME = ".active_workspace"
...
DEFAULT_RUNNER_LEASE_SECONDS = 120
DEFAULT_RUNNER_HEARTBEAT_SECONDS = 30

DEFAULT_MONITOR_CHUNK_SIZE = 50000
DEFAULT_MONITOR_SCROLLBACK = 100000
DEFAULT_MONITOR_LINE_HEIGHT = 1.0
DEFAULT_MONITOR_SIDEBAR_WIDTH_PCT = 15
MAX_MONITOR_CHUNK_SIZE = 4 * 1024 * 1024
MAX_MONITOR_SCROLLBACK = 1_000_000
MAX_MONITOR_LINE_HEIGHT = 2.5
DEFAULT_TASK_SUMMARY_SEARCH_TEXT_CHARS = 50_000
...
DEFAULT_BATCH_CONFIG_LIMIT = 10_000
